            ...
            <div className='xui-row'>
                ...
                <div className='xui-lg-col-7 xui-col-12 xui-pl-1'>
                    <div className='xui-px-1-half xui-pt-1 xui-pb-3 bg-gradient2 xui-bdr-rad-1 xui-max-h-500 xui-h-fluid-100'>
                        ...
                        {activeTab === 1 && 
                            <>
                                <h3 className='xui-font-sz-200 xui-font-w-500'>Architecting Future Possibilities</h3>
                        ...
                        {activeTab === 2 && 
                            <>
                                <h3 className='xui-font-sz-200 xui-font-w-500'>What Sets Us Apart</h3>
                        ...
                        {activeTab === 3 && 
                            <>
                                <h3 className='xui-font-sz-200 xui-font-w-500'>Systematic Innovation Engineering</h3>
