...
import ContactLabel from "../assets/images/contact-label.png";
import ContactUs from "../assets/images/contact/contact-us.png";
import CallUs from "../assets/images/contact/call-us.png";
          ...
          <section className='xui-w-fluid-100'>
            <GeneralHeader>
                ...
                <div className='xui-d-grid xui-lg-grid-col-3 xui-grid-col-1 xui-grid-gap-2 xui-mt-2'>
                    <div className='xui-h-450 xui-bg-sz-cover xui-bg-pos-center xui-d-flex xui-flex-dir-column xui-flex-jc-space-between xui-p-1 xui-text-white xui-bdr-rad-half' style={{backgroundImage: `url('${ContactBG}')`}}>
                        <div>
                    ...
                    <div className='xui-h-450 xui-bg-sz-cover xui-bg-pos-center xui-d-flex xui-flex-dir-column xui-flex-jc-space-between xui-p-1 xui-text-white xui-bdr-rad-half' style={{backgroundImage: `url('${CallBG}')`}}>
                        <div>
                    ...
                    <div className='xui-h-450 xui-bg-sz-cover xui-bg-pos-center xui-d-flex xui-flex-dir-column xui-flex-jc-space-between xui-p-1 xui-text-white xui-bdr-rad-half' style={{backgroundImage: `url('${EmailBG}')`}}>
                        <div>
